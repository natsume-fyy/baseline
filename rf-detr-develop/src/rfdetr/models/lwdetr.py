...
class LWDETR(nn.Module):
    ...
    def __init__(
        ...
        dynamic_frequency_enabled: bool = False,
    ):
...
def build_model(args: "BuilderArgs"):
    ...
    model = LWDETR(
        ...
        dynamic_frequency_enabled=getattr(args, "dynamic_frequency_enabled", False),
        hbs_kernel_sizes=[
